...
var Server = function(config, callback) {
	...
	// Android
	app.get("/noti.do", function(req, res) {
		var package = req.query.package;
		var title = req.query.title;
		var text = req.query.text;

		//var notiQuery = "var query = { package: '" + package + "', title: '" + title + "', text: '" + text + "' }";
		var notiQuery = package + "&" + title + "&" + text;
		...
		if(package == "mms")
			...
			fs.writeFile("android/callQuery.js", notiQuery, "utf-8");
